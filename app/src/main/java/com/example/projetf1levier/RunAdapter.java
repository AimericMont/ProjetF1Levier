...
public class RunAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        team cureentTeam=m_teams.getListOfTeam().get(position);
        ...
        numPlayerTeam.setImageResource(m_teams.getImageNum(cureentTeam.getNumberPlayerRun()));
        stepTeam.setImageResource(m_teams.getImageStep(cureentTeam.getNumberStepRun()));

        titlteTeam.setText("Equipe " + cureentTeam.getTeamNumber());
    ...
    public void start()
    {
        ...
        for (int i=0;i<m_teams.getListOfTeam().size();i++)
        {
            ...
            m_teams.getListOfTeam().get(i).setCurrntTime(0L);
        }
